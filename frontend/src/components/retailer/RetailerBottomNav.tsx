...
export const RetailerBottomNav: React.FC<RetailerBottomNavProps> = ({
  ...
  return (
    <nav className="sm:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 dark:bg-slate-950/95 backdrop-blur-xl border-t border-slate-200 dark:border-slate-800 px-2 py-1 flex items-center justify-around shadow-lg dark:shadow-2xl safe-area-bottom">
      {/* Tab 1: Home */}
      <button
        type="button"
